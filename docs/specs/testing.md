...
| ---------------------------------- | ----- | ------------------------- | ---------- |
| `arch.test.js`                     | 6     | none                      | Behavioral |
...
| `download.test.js`                 | 46    | core, github, exec        | Behavioral |
| `error-handler.test.js`            | 3     | core                      | Behavioral |
| `exec.test.js`                     | 5     | none                      | Behavioral |
| `github.test.js`                   | 10    | none                      | Behavioral |
| `install.test.js`                  | 26    | core, io, exec, check-k8s | Behavioral |
| `load-inputs.test.js`              | 10    | none                      | Behavioral |
| `shell-quote.test.js`              | 9     | none                      | Behavioral |
